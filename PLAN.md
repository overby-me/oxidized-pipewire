...
**227/227 Nix-level tests passing**, plus 39 internal Rust unit tests:
...
| **Now** | **227/227** | Every test passes; every user-facing tool has byte-identical option parity (including all error paths and connect-failure messages) |
