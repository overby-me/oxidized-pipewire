...
**259/259 Nix-level tests passing**, plus 39 internal Rust unit tests:
...
| **Now** | **259/259** | Every test passes; every user-facing tool has byte-identical option parity, including every short-alias of pw-cli's commands |
