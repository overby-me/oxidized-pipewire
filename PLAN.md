...
**221/221 Nix-level tests passing**, plus 39 internal Rust unit tests:
...
| **Now** | **221/221** | Every test passes; every user-facing tool has byte-identical option parity (including all error paths) |
