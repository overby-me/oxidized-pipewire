...
**234/234 Nix-level tests passing**, plus 39 internal Rust unit tests:
...
| **Now** | **234/234** | Every test passes; every user-facing tool has byte-identical option parity (including all error paths, connect-failure messages, pw-cat's static lists, and the no-op REPL commands) |
